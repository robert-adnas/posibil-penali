...
export function PartidPage() {
  ...
  const contextScopeTotals = useMemo(
    () => countDataScopes(allData, (politician) => nameToSlug(politician.party) === slug),
    [allData, slug]
  );
  ...
  const stats = useMemo(() => {
    ...
    return { convicted: convicted.length, totalYears, statusCounts };
  }, [politicians]);
    ...
    <div className="app-shell">
      <header className="app-section app-header">
        <div className="app-inner">
          <div className="app-kicker-row">
            ...
            <span className="app-kicker-meta">Partid</span>
            <ThemeToggle />
          </div>
      ...
      <main className="app-section app-main">
        <div className="app-inner">
          ...
          {Object.keys(stats.statusCounts).length > 1 && (
              ...
              {Object.entries(stats.statusCounts)
                ...
                .map(([status, count]) => (
                  <Link
                    ...
                    data-status={status}
                  >
                    <span className="partid-status-dot" />
          ...
          {allParties.length > 0 && (
            <div className="partid-other-parties">
              <h2 className="partid-other-title">Alte partide</h2>
